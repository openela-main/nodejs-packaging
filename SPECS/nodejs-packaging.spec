...
# Since nodejs package depends on python3.8 that is not shipped on ix86,
# and is therefore not built there, it is unnecessary to include that set
# of architectures here.
ExcludeArch: %{ix86}
